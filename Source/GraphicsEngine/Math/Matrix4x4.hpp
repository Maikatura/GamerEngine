...
namespace CommonUtilities
{
	...
	public:
		...
		void SetPosition(Vector4<float> aPosition);

		Vector4<float> GetPosition() const;
		Vector4<float> GetRotation() const;
		Vector4<float> GetScale() const;
	...
	template <class T>
	void Matrix4x4<T>::SetPosition(Vector4<float> aPosition)
	{
	...
	template <class T>
	Vector4<float> Matrix4x4<T>::GetPosition() const 
	{
		return Vector4<float>(myMatrix[3][0], myMatrix[3][1], myMatrix[3][2], 1.0f);
	}
}
