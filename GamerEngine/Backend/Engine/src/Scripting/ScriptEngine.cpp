...
namespace GamerEngine {
	...
	static std::unordered_map<std::string, ScriptFieldType> s_ScriptFieldTypeMap =
	{
		...
		//{ "GamerEngine.Vector2", ScriptFieldType::Vector2 },
		{ "GamerEngine.Vector3", ScriptFieldType::Vector3 },
		//{ "GamerEngine.Vector4", ScriptFieldType::Vector4 },

		{ "GamerEngine.Entity", ScriptFieldType::Entity },
	};
	...
	struct ScriptEngineData
	{
		...
		UnqRef<filewatch::FileWatch<std::string>> AppAssemblyFileWatcher;
	...
	void ScriptEngine::Init()
	{
		...
		s_Data->EntityClass = ScriptClass("GamerEngine", "Entity", true);
	}
	...
	bool ScriptEngine::LoadAssembly(const std::filesystem::path& filepath)
	{
		...
		s_Data->AppDomain = mono_domain_create_appdomain(appDomain.data(), nullptr);
	...
	bool ScriptEngine::LoadAppAssembly(const std::filesystem::path& filepath)
	{
		...
		s_Data->AppAssemblyFileWatcher = MakeUnqRef<filewatch::FileWatch<std::string>>(filepath.string(), OnAppAssemblyFileSystemEvent);
	...
	void ScriptEngine::LoadAssemblyClasses()
	{
		...
		int32_t numTypes = mono_table_info_get_rows(typeDefinitionsTable);
		MonoClass* entityClass = mono_class_from_name(s_Data->CoreAssemblyImage, "GamerEngine", "Entity");
