 ...
 namespace GamerEngine
 {
 	...
 	public:
 		...
 		//// Radial Impulse ////
 		void AddRadialImpulse(const Vector3f& origin, float radius, float strength, EFalloffMode falloff, bool velocityChange);

 		virtual void Teleport(Entity entity, const Vector3f& targetPosition, const Vector3f& targetRotation, bool force = false) = 0;
