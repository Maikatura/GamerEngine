...
// 				if (isStaticMesh)
// 				{
// 					PhysicsSystem::GetMeshCache().AddSimpleDebugMesh(colliderAsset, Ref<StaticMesh>::Create(meshSource->Handle, submeshIndices));
// 				}
// 				else
// 				{
// 					PhysicsSystem::GetMeshCache().AddSimpleDebugMesh(colliderAsset, Ref<Mesh>::Create(meshSource->Handle, submeshIndices));
// 				}
// 			}
// 			else
// 			{
// 				if (isStaticMesh)
// 				{
// 					PhysicsSystem::GetMeshCache().AddComplexDebugMesh(colliderAsset, Ref<StaticMesh>::Create(meshSource->Handle, submeshIndices));
// 				}
// 				else
// 				{
// 					PhysicsSystem::GetMeshCache().AddSimpleDebugMesh(colliderAsset, Ref<Mesh>::Create(meshSource->Handle, submeshIndices));
