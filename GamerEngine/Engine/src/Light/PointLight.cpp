...
void PointLight::Update()
{
	...
	myLightData.LightView[0] = Matrix4x4f::GetFastInverse(ComposeFromTRS(myLightData.Position, Quatf::FromEulers(ToRadians(Vector3f{ 0, -90, 0 })), { 1, 1, 1 }));
	myLightData.LightView[1] = Matrix4x4f::GetFastInverse(ComposeFromTRS(myLightData.Position, Quatf::FromEulers(ToRadians(Vector3f{ 0, 90, 0 })), { 1, 1, 1 }));
	myLightData.LightView[2] = Matrix4x4f::GetFastInverse(ComposeFromTRS(myLightData.Position, Quatf::FromEulers(ToRadians(Vector3f{ 90, 0, 0 })), { 1, 1, 1 }));
	myLightData.LightView[3] = Matrix4x4f::GetFastInverse(ComposeFromTRS(myLightData.Position, Quatf::FromEulers(ToRadians(Vector3f{ -90, 0, 0 })), { 1, 1, 1 }));
	myLightData.LightView[4] = Matrix4x4f::GetFastInverse(ComposeFromTRS(myLightData.Position, Quatf::FromEulers(ToRadians(Vector3f{ 0, 0, 0 })), { 1, 1, 1 }));
	myLightData.LightView[5] = Matrix4x4f::GetFastInverse(ComposeFromTRS(myLightData.Position, Quatf::FromEulers(ToRadians(Vector3f{ 0,  180, 0 })), { 1, 1, 1 }));
	...
	myLightData.Direction =	(ComposeFromTRS(myLightData.Position, Quatf::FromEulers(ToRadians(Vector3f{ 0, 0, 0 })), { 1, 1, 1 })).GetForward();
