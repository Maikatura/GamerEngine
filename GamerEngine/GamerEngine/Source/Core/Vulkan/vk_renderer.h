...
bool vk_init(VkContext *vkcontext, void *window)
{
    ...
    // Create a Pipeline
    {
        ...
        {
            int lengthInBytes;
            const char* mstr = "assets/shaders/shader.vert.spv";
            uint32_t *vertexCode = (uint32_t *)platform_read_file(mstr, &lengthInBytes);
        ...
        {
            int lengthInBytes;
            const char* mstr = "assets/shaders/shader.frag.spv";
            uint32_t *fragmentCode = (uint32_t *)platform_read_file(mstr, &lengthInBytes);
